    ...
    <div>
      <div className=" sticky top-[74px] z-40 flex justify-between bg-black p-6 items-center">
        <div className="flex text-white text-2xl font-bold">
          <img src={Content_Icon} alt="Upload Icon" className="h-10 w-10 mr-2" />
        ...
        <img
          src={upload}
          alt="Upload Icon"
          className="h-10 w-15 mr-2 hover:scale-105  "
                    ...
                    >
                      ...
                      <TableCell className="py-4 text-center">
                        <div className="flex justify-center gap-4">
                          ...
                          <button 
                            onClick={() => {
                              console.log("Button clicked", content.content_id);
            ...
            >
              <div className="flex justify-between items-center mb-2">
                <div className="flex gap-4">
                  ...
                  <button
                    onClick={() =>
                      console.log("DELETE CLICKED", content.content_id)
                    }
                  >
                    DELETE
                  </button>
