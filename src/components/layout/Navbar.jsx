    ...
    <nav className="fixed top-0 left-0 w-full  bg-[#03A9FC] p-4 shadow-md z-50">
      <div className="flex items-center justify-between">
        ...
        <div className=" hidden md:flex space-x-4 z-50">
          <Link
            to={"/"}
            className="border border-white text-white px-4 py-2 rounded-md font-medium hover:bg-white hover:text-black data-[state=active]:bg-[#03A9FC] data-[state=active]:text-white"
          >
            Fetch Device Info
          </Link>
          <Link
