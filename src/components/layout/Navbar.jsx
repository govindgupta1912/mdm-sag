...
//           <Link
//             to={"/"}
//             className="border border-white text-white px-4 py-2 transition rounded-md font-medium hover:bg-white hover:text-black data-[state=active]:bg-[#03A9FC] data-[state=active]:text-white"
//           >
//             Fetch Device Info
//           </Link>
//           <Link
